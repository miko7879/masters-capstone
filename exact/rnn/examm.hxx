...
class EXAMM {
    private:
        ...
        //FALA: Common Variables
        int num_stages;
        int genomes_per_stage;
        int curr_stage;
        int genomes_in_stage;
        
        
        //FALA: Genetic Operation FALA Variables
        double fala_lr;
        vector<double> rates;
        ...
        //FALA: Recurrent Depth FALA Variables
        double fala_rec_lr;
        vector<double> recurrent_depth_rates;
        vector<double> recurrent_depth_reinforcement_signal;
        double recurrent_depth_rate_min;
        double recurrent_depth_start_rate;
        double recurrent_depth_rate_degr_thres;
        map<int, int> recurrent_edge_counts;
        int total_depths;
